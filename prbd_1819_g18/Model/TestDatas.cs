...
namespace prbd_1819_g18
{
    public class TestDatas
    {
        ...
        private void testBooks()
        {
            runTest("Test livres", () =>
            {
                book1.AddCategory(new Category[] { catInformatique });
                book2.AddCategory(new Category[] { catRoman, catScienceFiction });
                book3.AddCategory(new Category[] { catRoman, catLitterature });
        ...
        private void testBasket()
        {
            runTest("Test Basket", () =>
            {
                ...
                printList("Rental Items du panier de ben", ben.Basket.Items);// comprend pas
